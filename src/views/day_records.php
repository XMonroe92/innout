<main class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h3><?= $today ?></h3>
            <p class="mb-0">Os registos efetuados hoje</p>
        </div>
        <div class="card-body">
    ...
    <div class="input-group no-border">
        <input type="text" name="forcedTime" class="form-control" placeholder="Simule o próximo ponto">
