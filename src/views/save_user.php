    ...
    <form action="#" method="post">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" id="name" name="name" placeholder="Introduza o nome" 
            ...
            <div class="form-group col-md-6">
                ...
                <input type="email" id="email" name="email" placeholder="Introduza o e-mail" 
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                <label for="confirm_password">Confirmação da Password</label>
                <input type="password" id="confirm_password" name="confirm_password" placeholder="Confirme a password" 
