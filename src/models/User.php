...
class User extends Model{
    ...
    private function validate(){
        ...
        if(!$this->start_date){
            ...
            $errors['start_date'] = 'A data não está num formato válido.';
        }

        if($this->end_date && !DateTime::createFromFormat('Y-m-d', $this->end_date)){
            $errors['end_date'] = 'A data não está num formato válido.';
        }
        ...
        if(!$this->confirm_password) {
            $errors['confirm_password'] = 'A confirmação de Password é um campo obrigatório.';
        }
